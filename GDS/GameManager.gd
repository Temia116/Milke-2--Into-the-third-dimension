...
func check_game_over():
	# Call this once a shot has fully resolved (ball exited/landed/timed out),
	# never mid-flight - otherwise firing your last ball ends the game
	# instantly instead of letting that final shot actually play out.
